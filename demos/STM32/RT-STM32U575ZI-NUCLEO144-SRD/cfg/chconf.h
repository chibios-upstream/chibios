...
extern void demoStop2KernelIrqPrologueHook(void);
#endif
#define CH_CFG_IRQ_PROLOGUE_HOOK() demoStop2KernelIrqPrologueHook()
 ...
 */
#if !defined(_FROM_ASM_)
extern void demoStop2IdleEnterHook(void);
#endif
#define CH_CFG_IDLE_ENTER_HOOK() demoStop2IdleEnterHook()
 ...
 */
#if !defined(_FROM_ASM_)
extern void demoStop2IdleLeaveHook(void);
#endif
#define CH_CFG_IDLE_LEAVE_HOOK() demoStop2IdleLeaveHook()
