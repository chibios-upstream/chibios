...
ifeq ($(USE_OPT),)
  USE_OPT = -Og -ggdb -fomit-frame-pointer -falign-functions=16 --specs=nano.specs
endif
...
# Required modules.
OOPSELECT := base referenced chprintf nullstreams
UTILSSELECT :=
...
# POSIX TTY over SIO files.
include $(CHIBIOS)/os/xhal/lib/complex/posix_tty-sio/hal_posix_tty_sio.mk
...
LDSCRIPT = ./ld/stm32g474re_nucleo64.ld
...
# Explicitly rebuild the sandbox apps and generate the ROMFS in ./source.
include $(CHIBIOS)/tools/mk/romfs.mk
