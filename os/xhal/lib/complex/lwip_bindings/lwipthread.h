...
#error "XHAL lwIP bindings require XHAL"
#endif

#if (CH_CFG_USE_EVENTS != TRUE)
#error "XHAL lwIP bindings require CH_CFG_USE_EVENTS"
#endif
 ...
 */
#if (HAL_USE_ETH != TRUE)
#error "XHAL lwIP bindings require HAL_USE_ETH"
#endif

#if (ETH_USE_SYNCHRONIZATION != TRUE)
#error "XHAL lwIP bindings require ETH_USE_SYNCHRONIZATION"
#endif

#if (ETH_USE_EVENTS != TRUE)
#error "XHAL lwIP bindings require ETH_USE_EVENTS"
#endif
