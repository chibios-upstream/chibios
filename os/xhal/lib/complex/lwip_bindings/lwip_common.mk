...
LWBINDSRC = \
        $(CHIBIOS)/os/xhal/lib/complex/lwip_bindings/lwipthread.c \
        $(CHIBIOS)/os/xhal/lib/complex/lwip_bindings/arch/sys_arch.c \
...
LWINC = \
        $(CHIBIOS)/os/xhal/lib/complex/lwip_bindings \
        $(LWIPDIR)/include
