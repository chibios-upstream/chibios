...
#define SPI_CFG1_DSIZE_MASK             SPI_CFG1_DSIZE_Msk
...
#if STM32_SPI_USE_SPI6 &&                                                   \
    !STM32_BDMA_IS_VALID_PRIORITY(STM32_SPI_SPI6_DMA_PRIORITY)
#error "Invalid BDMA priority assigned to SPI6"
#endif
...
#define spi_lld_driver_fields                                               \
  ...
  SPI_TypeDef               *spi;                                           \
  /* Maximum supported wire frame size.*/                                   \
  uint8_t                   max_dsize;                                      \
 ...
 */
/* SPI_MODE_FSIZE must match the rounded-up storage width of CFG1.DSIZE.*/
