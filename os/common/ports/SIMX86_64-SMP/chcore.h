...
/**
 * @file    SIMX86_64-SMP/chcore.h
 * @brief   SMP simulator on x86-64 port macros and structures.
 *
 ...
 */
/**
 * @brief   Number of simulated cores.
 */
 ...
 */
/**
 * Macro defining the simulated x86-64 base architecture.
 */
#define PORT_ARCHITECTURE_SIMX86_64

/**
 * Macro identifying the SMP simulator port.
 */
#define PORT_ARCHITECTURE_SIMX86_64_SMP

/**
 * Name of the implemented architecture.
 */
#define PORT_ARCHITECTURE_NAME          "SMP Simulator"

/**
 * @brief   Name of the architecture variant (optional).
 */
#define PORT_CORE_VARIANT_NAME          "x86-64 SMP (integer only)"
