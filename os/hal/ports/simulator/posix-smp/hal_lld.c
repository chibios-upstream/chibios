...
/**
 * @file    simulator/posix-smp/hal_lld.c
 * @brief   POSIX SMP simulator HAL subsystem low level driver code.
 *
 * @addtogroup POSIX_SMP_HAL
 * @{
 */
...
void _sim_check_for_interrupts(void) {
  ...
  if ((tv.tv_sec > nextcnt.tv_sec) ||
      ((tv.tv_sec == nextcnt.tv_sec) && (tv.tv_usec >= nextcnt.tv_usec))) {
    int_occurred = true;
    timeradd(&nextcnt, &tick, &nextcnt);
