...
/* The descriptor for 16K devices. */
static const flash_descriptor_t efl_lld_size1[STM32_FLASH_NUMBER_OF_BANKS] = {
      { /* Bank 1. */
       ...
       .sectors_count     = STM32_FLASH_SECTORS_TOTAL_16K,
       .sectors           = NULL,
       .sectors_size      = STM32_FLASH_SECTOR_SIZE_16K,
       .address           = (uint8_t *)FLASH_BASE,
       .size              = STM32_FLASH_SIZE_16K * STM32_FLASH_SIZE_SCALE
      }
};

/* The descriptor for 32K devices. */
static const flash_descriptor_t efl_lld_size2[STM32_FLASH_NUMBER_OF_BANKS] = {
      { /* Bank 1. */
       ...
       .sectors           = NULL,
       .sectors_size      = STM32_FLASH_SECTOR_SIZE_32K,
       .address           = (uint8_t *)FLASH_BASE,
...
static const flash_descriptor_t efl_lld_size5[STM32_FLASH_NUMBER_OF_BANKS] = {
      { /* Bank 1. */
       .attributes        = FLASH_ATTR_ERASED_IS_ONE |
                            FLASH_ATTR_MEMORY_MAPPED |
                            FLASH_ATTR_ECC_CAPABLE   |
...
flash_error_t efl_lld_read(void *instance, flash_offset_t offset,
  ...
  /* Ready state again. Unlike the G0 the U0 flash has no read error flag
     to check.*/
