...
/*
 * Setup for STMicroelectronics STM32 Nucleo144-U5A5ZJ-Q board.
 */

/*
 * Board identifier.
 */
#define BOARD_ST_NUCLEO144_U5A5ZJ_Q
#define BOARD_NAME                  "STMicroelectronics STM32 Nucleo144-U5A5ZJ-Q"
