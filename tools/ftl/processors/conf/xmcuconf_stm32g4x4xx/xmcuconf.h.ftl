...
#define STM32_IRQ_SPI2_PRIORITY             ${doc.STM32_I2S_SPI2_IRQ_PRIORITY!doc.STM32_IRQ_SPI2_PRIORITY!doc.STM32_SPI_SPI2_IRQ_PRIORITY!"10"}
[#else]
#define STM32_IRQ_SPI2_PRIORITY             ${doc.STM32_IRQ_SPI2_PRIORITY!doc.STM32_SPI_SPI2_IRQ_PRIORITY!doc.STM32_I2S_SPI2_IRQ_PRIORITY!"10"}
[/#if]
[#-- Preserve the priority of an instance assigned to I2S during migration. --]
[#if (doc.STM32_I2S_USE_SPI3!"FALSE")?trim?matches("\\(*\\s*(TRUE|1[Uu]?)\\s*\\)*")]
#define STM32_IRQ_SPI3_PRIORITY             ${doc.STM32_I2S_SPI3_IRQ_PRIORITY!doc.STM32_IRQ_SPI3_PRIORITY!doc.STM32_SPI_SPI3_IRQ_PRIORITY!"10"}
[#else]
#define STM32_IRQ_SPI3_PRIORITY             ${doc.STM32_IRQ_SPI3_PRIORITY!doc.STM32_SPI_SPI3_IRQ_PRIORITY!doc.STM32_I2S_SPI3_IRQ_PRIORITY!"10"}
[/#if]
...
#define STM32_IRQ_USB1_HP_PRIORITY         ${doc.STM32_IRQ_USB1_HP_PRIORITY!doc.STM32_USB_USB1_HP_IRQ_PRIORITY!"13"}
#define STM32_IRQ_USB1_LP_PRIORITY         ${doc.STM32_IRQ_USB1_LP_PRIORITY!doc.STM32_USB_USB1_LP_IRQ_PRIORITY!"14"}
...
#define STM32_I2S_DMA_ERROR_HOOK(i2sp)      ${doc.STM32_I2S_DMA_ERROR_HOOK!"chSysHalt(\"DMA failure\")"}
...
#define STM32_WSPI_DMA_ERROR_HOOK(wspip)    ${doc.STM32_WSPI_DMA_ERROR_HOOK!"chSysHalt(\"DMA failure\")"}
