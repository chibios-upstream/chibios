 ...
 * IRQ system settings.
 */
#define STM32_IRQ_ADC12_PRIORITY            ${doc.STM32_IRQ_ADC12_PRIORITY!"5"}

#define STM32_IRQ_ETH1_PRIORITY             ${doc.STM32_IRQ_ETH1_PRIORITY!"13"}
...
#define STM32_IRQ_OCTOSPI1_PRIORITY         STM32_IRQ_MDMA_PRIORITY
#define STM32_IRQ_OCTOSPI2_PRIORITY         STM32_IRQ_MDMA_PRIORITY

#define STM32_IRQ_OTG2_PRIORITY             ${doc.STM32_IRQ_OTG2_PRIORITY!"14"}
 ...
 */
#define STM32_ETH_TRANSMIT_BUFFERS          ${doc.STM32_ETH_TRANSMIT_BUFFERS!"2"}
#define STM32_ETH_RECEIVE_BUFFERS           ${doc.STM32_ETH_RECEIVE_BUFFERS!"4"}
#define STM32_ETH_BUFFERS_SIZE              ${doc.STM32_ETH_BUFFERS_SIZE!"1524"}
#define STM32_ETH_PHY_TIMEOUT               ${doc.STM32_ETH_PHY_TIMEOUT!"100"}
#define STM32_ETH_ETH1_CHANGE_PHY_STATE     ${doc.STM32_ETH_ETH1_CHANGE_PHY_STATE!"TRUE"}
#define STM32_ETH_IP_CHECKSUM_OFFLOAD       ${doc.STM32_ETH_IP_CHECKSUM_OFFLOAD!"0"}
