 ...
 * Shared IRQ settings.
 */
#define STM32_IRQ_ADC1_COMP_PRIORITY        ${doc.STM32_IRQ_ADC1_COMP_PRIORITY!"2"}
...
#define STM32_IRQ_RTC_TAMP_PRIORITY         ${doc.STM32_IRQ_RTC_TAMP_PRIORITY!"3"}
...
#define STM32_IRQ_TIM6_DAC_LPTIM1_PRIORITY  ${doc.STM32_IRQ_TIM6_DAC_LPTIM1_PRIORITY!"1"}
