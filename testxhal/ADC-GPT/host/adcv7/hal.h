...
/* Host scaffolding for the actual XHAL ADC frontend and ADCv7 LLD. */
#ifndef TEST_ADCV7_HAL_H
#define TEST_ADCV7_HAL_H
...
#define STM32U385xx
#define STM32U3XX
#define STM32_HCLK 96000000U
#define STM32_ADC1_CLOCK 48000000U
#define STM32_ADCCLK_MAX 55000000U
#define STM32_IRQ_ADC1_PRIORITY 5
#define STM32_IRQ_ADC2_PRIORITY 7
...
#endif
#define STM32_ADC_ADC1_DMA3_CHANNEL 1U
#define STM32_ADC_ADC2_DMA3_CHANNEL 2U
...
static unsigned test_errors, test_enables, test_disables;
static unsigned test_irq_priority[128];
...
#define nvicEnableVector(n, p) (test_irq_priority[n] = (p))
...
#define ADC12_COMMON (&test_hw->common)
#define rccEnableADC12(lp) (assert(test_locked), (void)(lp), test_enables++)
#define rccDisableADC12() (assert(test_locked), test_disables++)
#define rccResetADC12() test_reset()

#endif /* TEST_ADCV7_HAL_H */
