...
#else
#define PORTAB_ADC1                         ADCD3
#endif
#define PORTAB_GPT1                         GPTD4
#define PORTAB_GPT1_PERIOD                  100U

/* Buffers are accessible to DMA and BDMA and covered by the MPU region.*/
#define PORTAB_ADC_BUFFER_ATTRIBUTE CC_ALIGN_DATA(32) CC_SECTION(".ram4")

#if STM32_ADC_DUAL_MODE
#define ADC_GRP1_NUM_CHANNELS               4U
#else
#define ADC_GRP1_NUM_CHANNELS               2U
#endif
#define ADC_GRP2_NUM_CHANNELS               ADC_GRP1_NUM_CHANNELS
#define ADC_GRP3_NUM_CHANNELS               ADC_GRP1_NUM_CHANNELS
#define ADC_GRP1                            0U
#define ADC_GRP2                            1U
#define ADC_GRP3                            2U
