...
/* Hardware/RTOS shim for the actual XHAL CAN frontend and FDCANv2 LLD. */
#ifndef TEST_FDCANV2_HAL_H
#define TEST_FDCANV2_HAL_H
...
#include <stdint.h>
#include <string.h>
#if defined(TEST_H743)
#define STM32H743xx
#include "stm32h743xx.h"
#elif defined(TEST_H7A3)
#define STM32H7A3xxQ
...
#define STM32H7XX
#ifndef STM32_CAN_USE_FDCAN1
#define STM32_CAN_USE_FDCAN1 TRUE
#endif
#ifndef STM32_CAN_USE_FDCAN2
#define STM32_CAN_USE_FDCAN2 TRUE
#endif
#ifndef STM32_CAN_USE_FDCAN3
#if defined(TEST_H743) || defined(TEST_H7A3)
...
static FDCAN_GlobalTypeDef test_regs[3];
static uint32_t test_ram[2562];
static FDCAN_GlobalTypeDef *stuck_unit;
...
#undef FDCAN3
#undef SRAMCAN_BASE
#define FDCAN1 (&test_regs[0])
#define FDCAN2 (&test_regs[1])
#define FDCAN3 (&test_regs[2])
#define SRAMCAN_BASE ((uintptr_t)&test_ram[1])
#define rccEnableFDCAN(lp) (assert(test_locked && !clock_on), \
                            (void)(lp), clock_on = true, clock_enables++)
#define rccDisableFDCAN() (assert(test_locked && clock_on), \
                           clock_on = false, clock_disables++)
#define rccResetFDCAN() test_reset()

#endif /* TEST_FDCANV2_HAL_H */
