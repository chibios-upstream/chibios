...
CHIBIOS = ../../..
CONFDIR  := ./cfg
BUILDDIR := ./build/ARMv6-M-ALT
DEPDIR   := ./.dep/ARMv6-M-ALT
REPORT   := misra-RT-ARMv6-M-ALT.txt
...
include $(CHIBIOS)/os/common/ports/ARMv6-M-ALT/compilers/GCC/mk/port.mk
...
UDEFS = -DSTM32G0B1xx -DCH_CFG_USE_TM=FALSE

# Define ASM defines here
UADEFS = -DSTM32G0B1xx -DCH_CFG_USE_TM=FALSE
